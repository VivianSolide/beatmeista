...
$("#go").click(function() {
  ...
  //   if (sl1.answers.answerHhOpened[$(this).attr("position")] == 0) {
  //     new Audio(
  //       "/home/vivian/Bureau/IRON HACK/2_PROJECTS/beatmeista/sounds/1/hho.wav"
  //     ).play();
  //     sl1.answers.answerHhOpened.splice($(this).attr("position"), 1, 1);
  //   } else if (sl1.answers.answerHhOpened[$(this).attr("position")] == 1) {
  //     sl1.answers.answerHhOpened.splice($(this).attr("position"), 1, 0);
  //   }
  // });
  // ////  hhc
  // $("#tracks > div.track1 > button").click(function() {
  //   $(this).toggleClass("hhc");
  //   if (sl1.answers.answerHhClosed[$(this).attr("position")] == 0) {
  //     new Audio(
  //       "/home/vivian/Bureau/IRON HACK/2_PROJECTS/beatmeista/sounds/1/hhc.wav"
  //     ).play();
  //     sl1.answers.answerHhClosed.splice($(this).attr("position"), 1, 1);
  //   } else if (sl1.answers.answerHhClosed[$(this).attr("position")] == 1) {
  //     sl1.answers.answerHhClosed.splice($(this).attr("position"), 1, 0);
  //   }
  // });
  // ////  snare
  // $("#tracks > div.track2 > button").click(function() {
  //   $(this).toggleClass("s");
  //   if (sl1.answers.answerSnare[$(this).attr("position")] == 0) {
  //     new Audio(
  //       "/home/vivian/Bureau/IRON HACK/2_PROJECTS/beatmeista/sounds/1/s.wav"
  //     ).play();
  //     sl1.answers.answerSnare.splice($(this).attr("position"), 1, 1);
  //   } else if (sl1.answers.answerSnare[$(this).attr("position")] == 1) {
  //     sl1.answers.answerSnare.splice($(this).attr("position"), 1, 0);
  //   }
  // });
  // ////  kick
  // $("#tracks > div.track3 > button").click(function() {
  //   $(this).toggleClass("k");
  //   if (sl1.answers.answerKick[$(this).attr("position")] == 0) {
  //     new Audio(
  //       "/home/vivian/Bureau/IRON HACK/2_PROJECTS/beatmeista/sounds/1/k.wav"
  //     ).play();
  //     sl1.answers.answerKick.splice($(this).attr("position"), 1, 1);
  //   } else if (sl1.answers.answerKick[$(this).attr("position")] == 1) {
  //     sl1.answers.answerKick.splice($(this).attr("position"), 1, 0);
  //   }
  // });
  ...
  setInterval(function() {
    ////hhopened
    if (_.isEqual(sl1.answers.answerHhOpened, check[0].checkHhOpened))
      $("#tracks > div.track0 > img.nope")
        .removeClass()
        .addClass("item align-top");
    else if (!_.isEqual(sl1.answers.answerHhOpened, check[0].checkHhOpened))
      $("#tracks > div.track0 > img.nope")
        .removeClass()
        .addClass("nope");
    ////hhclosed
    if (_.isEqual(sl1.answers.answerHhClosed, check[0].checkHhClosed))
      $("#tracks > div.track1 > img.nope")
        .removeClass()
        .addClass("item align-top");
    else if (!_.isEqual(sl1.answers.answerHhClosed, check[0].checkHhClosed))
      $("#tracks > div.track1 > img.nope")
        .removeClass()
        .addClass("nope");
    ////snare
    if (_.isEqual(sl1.answers.answerSnare, check[0].checkSnare))
      $("#tracks > div.track2 > img.nope")
        .removeClass()
        .addClass("item align-top");
    else if (!_.isEqual(sl1.answers.answerSnare, check[0].checkSnare))
      $("#tracks > div.track2 > img.nope")
        .removeClass()
        .addClass("nope");
    ////kick
    if (_.isEqual(sl1.answers.answerKick, check[0].checkKick))
      $("#tracks > div.track3 > img.nope")
        .removeClass()
        .addClass("item align-top");
    else if (!_.isEqual(sl1.answers.answerKick, check[0].checkKick))
      $("#tracks > div.track3 > img.nope")
        .removeClass()
        .addClass("nope");
    if (
      _.isEqual(sl1.answers.answerHhOpened, check[0].checkHhOpened) &&
      _.isEqual(sl1.answers.answerHhClosed, check[0].checkHhClosed) &&
      _.isEqual(sl1.answers.answerSnare, check[0].checkSnare) &&
      _.isEqual(sl1.answers.answerKick, check[0].checkKick)
    ) {
